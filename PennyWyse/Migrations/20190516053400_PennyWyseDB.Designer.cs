...
namespace PennyWyse.Migrations
{
    ...
    [Migration("20190516053400_PennyWyseDB")]
            ...
            modelBuilder.Entity("PennyWyse.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            EventId = 1,
                            City = "Nashville",
                            CreatorId = "ca068d14-727f-4c19-9c93-e83005f57171",
                        ...
                        new
                        {
                            EventId = 4,
                            City = "Nashville",
                            CreatorId = "86d894ac-ca08-46f4-98f0-fee17e043001",
                        ...
                        new
                        {
                            EventId = 5,
                            City = "Manchester",
                            CreatorId = "eeda0ee7-94c9-4cb0-a003-f5ad8a5e0004",
            ...
            modelBuilder.Entity("PennyWyse.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "ca068d14-727f-4c19-9c93-e83005f57171",
                            AccessFailedCount = 0,
                            City = "Nashville",
                            ConcurrencyStamp = "39ffa977-29ce-422f-af15-475986994571",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEJTSX+tpsrSlLvjNzksug8s4Q31ksI6erTRZVCwM6xRwqRy/ipIHL5GdqqoahKax9A==",
                            PhoneNumberConfirmed = false,
                            ProfileImageURL = "https://s3.amazonaws.com/37assets/svn/1065-IMG_2529.jpg",
                            SecurityStamp = "f11c94fd-c43e-4f53-945b-49e07f2eb488",
                            State = "Tennessee",
                        ...
                        new
                        {
                            Id = "86d894ac-ca08-46f4-98f0-fee17e043001",
                            AccessFailedCount = 0,
                            City = "Nashville",
                            ConcurrencyStamp = "ba9d9bcb-be8d-4eed-a9d5-1effca623b9a",
                            Email = "jd@jd.com",
                            EmailConfirmed = true,
                            FirstName = "JD",
                            LastName = "Wheeler",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAECRIT6t+jPvaEUSsifkkWxGRVagdvCZonpfxu/HbpswFVh6ene8CZk7mtDIpysftyA==",
                            PhoneNumberConfirmed = false,
                            ProfileImageURL = "https://s3.amazonaws.com/37assets/svn/1065-IMG_2529.jpg",
                            SecurityStamp = "175ac78e-8d09-4d44-b0f7-b9e397f0b44f",
                            State = "Tennessee",
                            TwoFactorEnabled = false,
                            UserName = "jd@jd.com"
                        },
                        new
                        {
                            Id = "eeda0ee7-94c9-4cb0-a003-f5ad8a5e0004",
                            AccessFailedCount = 0,
                            City = "Nashville",
                            ConcurrencyStamp = "d94a6ef6-1ff9-4b03-abf1-50b519fa390f",
                            Email = "joey@joey.com",
                            EmailConfirmed = true,
                            FirstName = "Joey",
                            LastName = "B",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEEygrpSqtcH26zDZzGuGolghv/kaoWihxDm5cEhvEsownbwudb3DyqWPSya3gIEfJw==",
                            PhoneNumberConfirmed = false,
                            ProfileImageURL = "https://s3.amazonaws.com/37assets/svn/1065-IMG_2529.jpg",
                            SecurityStamp = "38bd4e7f-c93f-4130-84e3-c56618c95d88",
                            State = "Tennessee",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("PennyWyse.Models.UserEvent", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserEventId = 1,
                            EventId = 1,
                            UserId = "86d894ac-ca08-46f4-98f0-fee17e043001"
                        },
                        new
                        {
                            UserEventId = 2,
                        ...
                        new
                        {
                            UserEventId = 3,
                            EventId = 3,
                            UserId = "eeda0ee7-94c9-4cb0-a003-f5ad8a5e0004"
                        });
                });
